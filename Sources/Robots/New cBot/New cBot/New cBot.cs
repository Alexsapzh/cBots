...
namespace cAlgo.Robots
{
    ...
    public class Prototype : Robot
    {
        ...
        [Parameter("EMA_Period", DefaultValue = 0)]
        public double _EMA_Period { get; set; }
        ...
        //Global declaration
        private ExponentialMovingAverage i_EMA;
        private SimpleMovingAverage i_Last_EMA2;
        private SimpleMovingAverage i_Current_EMA2;
        private SimpleMovingAverage i_Current_EMA;
        private SimpleMovingAverage i_Last_EMA;
        bool _Below_EMA;
        bool _AND_3;
        bool _AND_4;
        ...
        protected override void OnTick()
        {
            ...
            //Step 2
            _Below_EMA = (MarketSeries.Close.Last(0) < i_EMA.Result.Last(0));

            //Step 3
            if ((MarketSeries.Close.Last(0) > i_EMA.Result.Last(0)))
                _Buy = _OpenPosition(0, true, Symbol.Code, TradeType.Buy, 0.1, 0, _StopLoss, _TP, "");
            if (_Below_EMA)
                _Sell = _OpenPosition(0, true, Symbol.Code, TradeType.Sell, 0.1, 0, _StopLoss, _TP, "");
            _AND_3 = ((MarketSeries.Close.Last(0) > i_EMA.Result.Last(0)));
            _AND_4 = (_Below_EMA);
