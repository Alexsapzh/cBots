...
namespace cAlgo
{
    ...
    public class TheMajorV2 : Robot
    {
        ...
        {
            get { return rsilong && macdlong && hmalong && localTendencyIsLong && globalTendencyIsLong; }
        }
        public bool shortSignal
        {
            get { return rsishort && macdshort && hmashort && localTendencyIsShort && globalTendencyIsShort; }
        }
