...
namespace cAlgo
{
    ...
    public class TheMajorV2PSarMulti : Robot
    {
        ...
        [Parameter(DefaultValue = 1000, Step = 1000, MinValue = 10)]
        ...
        public bool ziglong
        {
            get { return _zigzag.Result.Last(0) > _zigzag.Result.Last(1); }
        }

        public bool zigshort
        {
            get { return _zigzag.Result.Last(0) < _zigzag.Result.Last(1); }
        }
