...
namespace cAlgo
{
    ...
    public class LaTortugaV3SGPipStep : Robot
    {
        ...
        protected override void OnBar()
        {
            ...
            if (previoushmaslow > previoushmafast && currenthmaslow <= currenthmafast && hmaSignal.IsBullish)
            {
                fBuy();
            }
            else if (previoushmaslow < previoushmafast && currenthmaslow >= currenthmafast && hmaSignal.IsBearish)
            {
                fSell();
            }
            {
