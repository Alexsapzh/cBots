...
{
    [Robot()]
    public class MultiPosHMA2 : Robot
    {
        ...
        [Parameter("Take Profit (pips)", DefaultValue = 5, MinValue = 5, MaxValue = 200, Step = 1)]
        ...
        [Parameter("MinBalance", DefaultValue = 100, MinValue = 100, MaxValue = 5000, Step = 1)]
        public double MinBalance { get; set; }

        [Parameter("MinLoss", DefaultValue = -800, MinValue = -800, MaxValue = -99, Step = 1)]
        ...
        [Parameter(DefaultValue = 3, MinValue = 3, MaxValue = 20, Step = 1)]
        ...
        protected override void OnBar()
        {
            ...
            // Condition to Buy
            if (_hmaslow.hmaslow.Last(0) > _hmaslow.hmaslow.Last(1))
                ExecuteMarketOrder(TradeType.Buy, Symbol, Volume, cBotLabel, StopLoss, TakeProfit);
            else if (_hmaslow.hmaslow.Last(0) < _hmaslow.hmaslow.Last(1))
