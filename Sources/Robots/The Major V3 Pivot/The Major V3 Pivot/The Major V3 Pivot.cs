...
namespace cAlgo
{
    ...
    public class TheMajorV3Pivot : Robot
    {
        ...
        {
            get { return supportlong && rsilong && macdlong && hmalong && localTendencyIsLong && globalTendencyIsLong && pivotlong && rsirising && mfilong; }
        }
        public bool shortSignal
        {
            get { return resistanceshort && rsishort && macdshort && hmashort && localTendencyIsShort && globalTendencyIsShort && pivotshort && rsifalling && mfishort; }
        }
        ...
        public bool hmalong
        {
            get { return MarketSeries.Low.LastValue >= _hmaslow.hmaslow.Last(0) && _hmaslow.hmaslow.IsRising(); }
        }

        public bool hmashort
        {
            get { return MarketSeries.High.LastValue <= _hmaslow.hmaslow.Last(1) && _hmaslow.hmaslow.IsFalling(); }
        }
        ...
        public bool pivotlong
        {
            get { return MarketSeries.Low.LastValue > _FPP.Pivot.LastValue; }
        }

        public bool pivotshort
        {
            get { return MarketSeries.High.LastValue < _FPP.Pivot.LastValue; }
        }

        public bool mfilong
        {
            get { return _moneyFlow.Result.LastValue <= 30 && _moneyFlow.Result.IsRising(); }
        }

        public bool mfishort
        {
            get { return _moneyFlow.Result.LastValue >= 70 && _moneyFlow.Result.IsFalling(); }
        }
