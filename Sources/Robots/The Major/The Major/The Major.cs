...
namespace cAlgo
{
    ...
    public class TheMajor : Robot
    {
        ...
        {
            get { return supportlong && rsilong && macdlong && hmalong && localTendencyIsLong && globalTendencyIsLong; }
        }
        public bool shortSignal
        {
            get { return resistanceshort && rsishort && macdshort && hmashort && localTendencyIsShort && globalTendencyIsShort; }
        }
        ...
        public bool hmalong
        {
            get { return _hmaslow.hmaslow.Last(0) > _hmafast.hmafast.Last(1); }
        }

        public bool hmashort
        {
            get { return _hmaslow.hmaslow.Last(1) < _hmafast.hmafast.Last(0); }
        }
        ...
        protected override void OnBar()
        {
            ...
            var currenthmafast = _hmafast.hmafast.Last(0);
            var previoushmaslow = _hmaslow.hmaslow.Last(1);
            var previoushmafast = _hmafast.hmafast.Last(1);
