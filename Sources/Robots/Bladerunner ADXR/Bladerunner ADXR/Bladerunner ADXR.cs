...
namespace cAlgo
{
    ...
    public class BladerunnerMajor : Robot
    {
        ...
        {
            get { return adxrlong && adxrtrend && macdlong && localTendencyIsLong && globalTendencyIsLong; }
        }
        public bool shortSignal
        {
            get { return adxrshort && adxrtrend && macdshort && localTendencyIsShort && globalTendencyIsShort; }
        }
        ...
        {
            get { return _adx.diminus[index - 1] > _adx.diplus[index - 1] && _adx.diminus[index] <= _adx.diplus[index]; }
        }
        ...
        //public bool adxrlong
        //{
        //get { return _adx.diminus[index] > _adx.diplus[index]; }
        //}
        //public bool adxrshort
        //{
        //get { return _adx.diminus[index] < _adx.diplus[index]; }
