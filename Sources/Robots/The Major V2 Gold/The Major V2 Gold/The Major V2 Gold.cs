...
namespace cAlgo
{
    ...
    public class TheMajorV2Gold : Robot
    {
        ...
        [Parameter(DefaultValue = 100, Step = 1, MinValue = 1)]
        ...
        {
            get { return supportlong && rsilong && macdlong && hmalong && localTendencyIsLong && globalTendencyIsLong && rsirising; }
        }
        public bool shortSignal
        {
            get { return resistanceshort && rsishort && macdshort && hmashort && localTendencyIsShort && globalTendencyIsShort && rsifalling; }
        }
