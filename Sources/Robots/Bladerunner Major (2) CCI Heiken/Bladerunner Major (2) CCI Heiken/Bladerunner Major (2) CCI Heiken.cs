...
namespace cAlgo
{
    ...
    public class BladerunnerMajorCCIHeiken : Robot
    {
        ...
        {
            get { return adxrtrend && macdlong && emalong && ccilong && localTendencyIsLong && globalTendencyIsLong; }
        }
        public bool shortSignal
        {
            get { return adxrtrend && macdshort && emashort && ccishort && localTendencyIsShort && globalTendencyIsShort; }
        }
        ...
        public bool emalong
        {
            get { return _heiken.xOpen[index] > _emaFast.Result[index] && _emaFast.Result.IsRising() && _heiken.xClose[index] > _heiken.xOpen[index]; }
        }
        public bool emashort
        {
            get { return _heiken.xOpen[index] < _emaFast.Result[index] && _emaFast.Result.IsFalling() && _heiken.xClose[index] < _heiken.xOpen[index]; }
        }
        //public bool emalong
        //{
        ...
        public bool ccilong
        {
            get { return _cci.CCIa[index] >= 0; }
        }
        public bool ccishort
        {
            get { return _cci.CCIa[index] <= 0; }
        }
