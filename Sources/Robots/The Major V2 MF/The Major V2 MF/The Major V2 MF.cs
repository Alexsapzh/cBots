...
namespace cAlgo
{
    ...
    public class TheMajorV2MF : Robot
    {
        ...
        [Parameter("MFI Period", DefaultValue = 14, MinValue = 2, MaxValue = 40, Step = 1)]
        ...
        {
            get { return supportlong && rsilong && macdlong && hmalong && localTendencyIsLong && globalTendencyIsLong && rsirising && mfilong; }
        }
        public bool shortSignal
        {
            get { return resistanceshort && rsishort && macdshort && hmashort && localTendencyIsShort && globalTendencyIsShort && rsifalling && mfishort; }
        }
        ...
        {
            get { return MarketSeries.High.LastValue <= _hmaslow.hmaslow.Last(0) && _hmaslow.hmaslow.IsFalling(); }
        }
        ...
        protected override void OnBar()
        {
            ...
            var mficurrentValue = _moneyFlow.Result.LastValue;
