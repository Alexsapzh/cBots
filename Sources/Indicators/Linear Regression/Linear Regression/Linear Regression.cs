...
namespace cAlgo.Indicators
{
    ...
    [Levels()]
    public class LinearRegressionChannel_Indicator : Indicator
    {
        Mq4Double Mq4Init()
        {
        ...
        Mq4Double Mq4Start()
        {
            ...
            if (c == 0.0)
            {
                Alert("Error in_ linear regression!");
                return 0;
            }
        ...
        [Parameter("barsToCount", DefaultValue = 50)]
        public int barsToCount_parameter { get; set; }
        bool _barsToCountGot;
        Mq4Double barsToCount_backfield;
        Mq4Double barsToCount
        {
            get
            {
                if (!_barsToCountGot)
                    barsToCount_backfield = barsToCount_parameter;
                return barsToCount_backfield;
            }
            set { barsToCount_backfield = value; }
        }



        [Output("LR_line", Color = Colors.Gold, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries LR_line_AlgoOutputDataSeries { get; set; }
        [Output("Sup_line", Color = Colors.Aqua, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries Sup_line_AlgoOutputDataSeries { get; set; }
        [Output("Res_line", Color = Colors.OrangeRed, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries Res_line_AlgoOutputDataSeries { get; set; }




        int indicator_buffers = 3;
        int indicator_color1 = Gold;
        int indicator_color2 = Aqua;
        ...
        private Mq4OutputDataSeries LR_line;
        private Mq4OutputDataSeries Sup_line;
        private Mq4OutputDataSeries Res_line;
        ...
        {
            if (LR_line_AlgoOutputDataSeries == null)
                LR_line_AlgoOutputDataSeries = CreateDataSeries();
            LR_line = new Mq4OutputDataSeries(this, LR_line_AlgoOutputDataSeries, ChartObjects, 0, 0, () => CreateDataSeries(), 1, Colors.Gold);
            AllBuffers.Add(LR_line);
            if (Sup_line_AlgoOutputDataSeries == null)
                Sup_line_AlgoOutputDataSeries = CreateDataSeries();
            Sup_line = new Mq4OutputDataSeries(this, Sup_line_AlgoOutputDataSeries, ChartObjects, 0, 1, () => CreateDataSeries(), 1, Colors.Aqua);
            AllBuffers.Add(Sup_line);
            if (Res_line_AlgoOutputDataSeries == null)
                Res_line_AlgoOutputDataSeries = CreateDataSeries();
            Res_line = new Mq4OutputDataSeries(this, Res_line_AlgoOutputDataSeries, ChartObjects, 0, 2, () => CreateDataSeries(), 1, Colors.OrangeRed);
            AllBuffers.Add(Res_line);

            AllOutputDataSeries.Add(LR_line_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(Sup_line_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(Res_line_AlgoOutputDataSeries);
        ...
        public override void Calculate(int index)
        {
            ...
            {
                _currentIndex = index;
                LR_line.SetCurrentIndex(index);
                Sup_line.SetCurrentIndex(index);
                Res_line.SetCurrentIndex(index);
...
//{
        ...
        class Mq4OutputDataSeries : IMq4DoubleArray
        {
            ...
            private readonly LinearRegressionChannel_Indicator _indicator;

            public Mq4OutputDataSeries(LinearRegressionChannel_Indicator indicator, IndicatorDataSeries outputDataSeries, ChartObjects chartObjects, int style, int bufferIndex, Func<IndicatorDataSeries> dataSeriesFactory, int lineWidth, Colors? color = null)
            {
            ...
            public override void Draw()
            {
                ...
                switch (ArrowCode)
                {
                    ...
                    case SYMBOL_LEFTPRICE:
                        ...
                        break;
                    default:
                        arrowString = LinearRegressionChannel_Indicator.GetArrowByCode(ArrowCode);
