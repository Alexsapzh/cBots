...
namespace cAlgo.Indicators
{
    ...
    [Levels()]
    public class GANN_rvm_v4_Indicator : Indicator
    {
        Mq4Double Mq4Init()
        {
        ...
        Mq4Double BBarBeginFunc(Mq4Double bar, Mq4Double TF)
        {
            Mq4Double bbegin = false;
            bbegin = 0;
            if (TF != 10080)
            {
        ...
        Mq4Double NewTicFunc(Mq4Double Bar)
        {
            Mq4Double sBL = 0;
            Mq4Double sL = 0;
            Mq4Double sH = 0;
            ...
            if (High[Bar] > MyArr[ArrIdx][3])
                MyArr[ArrIdx][3] = High[Bar];
            if (Low[Bar] < MyArr[ArrIdx][4])
        ...
        Mq4Double FBarFunc(Mq4Double Bar)
        {
        ...
        Mq4Double NewBarFunc(Mq4Double Bar)
        {
            Mq4Double sBL = 0;
            Mq4Double sL = 0;
            Mq4Double sH = 0;
        ...
        Mq4Double NBBarFunc(Mq4Double Bar)
        {
            Mq4Double sBL = 0;
            Mq4Double sL = 0;
            Mq4Double sH = 0;
        ...
        [Parameter("NextTF", DefaultValue = 15)]
        public int NextTF_parameter { get; set; }
        bool _NextTFGot;
        Mq4Double NextTF_backfield;
        Mq4Double NextTF
        {
            get
            {
                if (!_NextTFGot)
                    NextTF_backfield = NextTF_parameter;
                return NextTF_backfield;
            }
            set { NextTF_backfield = value; }
        }

        [Parameter("BL_Range", DefaultValue = 5)]
        public int BL_Range_parameter { get; set; }
        bool _BL_RangeGot;
        Mq4Double BL_Range_backfield;
        Mq4Double BL_Range
        {
            get
            {
                if (!_BL_RangeGot)
                    BL_Range_backfield = BL_Range_parameter;
                return BL_Range_backfield;
            }
            set { BL_Range_backfield = value; }
        }

        [Parameter("HLN_Range", DefaultValue = 3)]
        public int HLN_Range_parameter { get; set; }
        bool _HLN_RangeGot;
        Mq4Double HLN_Range_backfield;
        Mq4Double HLN_Range
        {
            get
            {
                if (!_HLN_RangeGot)
                    HLN_Range_backfield = HLN_Range_parameter;
                return HLN_Range_backfield;
            }
            set { HLN_Range_backfield = value; }
        }

        [Parameter("HLN_UseFullTF", DefaultValue = false)]
        public bool HLN_UseFullTF_parameter { get; set; }
        bool _HLN_UseFullTFGot;
        Mq4Double HLN_UseFullTF_backfield;
        Mq4Double HLN_UseFullTF
        {
            get
            {
                if (!_HLN_UseFullTFGot)
                    HLN_UseFullTF_backfield = HLN_UseFullTF_parameter;
                return HLN_UseFullTF_backfield;
            }
            set { HLN_UseFullTF_backfield = value; }
        }



        [Output("HLNUp_sl", Color = Colors.DeepSkyBlue, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries HLNUp_sl_AlgoOutputDataSeries { get; set; }
        [Output("HLNDn_sl", Color = Colors.Black, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries HLNDn_sl_AlgoOutputDataSeries { get; set; }
        [Output("HLNUp", Color = Colors.DeepSkyBlue, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries HLNUp_AlgoOutputDataSeries { get; set; }
        [Output("HLNDn", Color = Colors.Black, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries HLNDn_AlgoOutputDataSeries { get; set; }
        [Output("BLLev", Color = Colors.Yellow, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries BLLev_AlgoOutputDataSeries { get; set; }
        [Output("BLStep", Color = Colors.Green, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries BLStep_AlgoOutputDataSeries { get; set; }
        [Output("ExtMapBuffer7", Color = Colors.Red, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries ExtMapBuffer7_AlgoOutputDataSeries { get; set; }
        [Output("ExtMapBuffer8", Color = Colors.Red, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries ExtMapBuffer8_AlgoOutputDataSeries { get; set; }


        Mq4DoubleTwoDimensionalArray MyArr = new Mq4DoubleTwoDimensionalArray(10);
        Mq4Double lb;
        Mq4Double ArrIdx;
        Mq4Double ArrSize;
        Mq4Double dig;
        Mq4Double Displacement;
        Mq4Double initfl;
        Mq4Double NextTFs;

        int indicator_buffers = 8;
        int indicator_color1 = DeepSkyBlue;
        int indicator_color2 = Black;
        int indicator_color3 = DeepSkyBlue;
        int indicator_color4 = Black;
        int indicator_color5 = Yellow;
        int indicator_color6 = Green;
        int indicator_color7 = Red;
        int indicator_color8 = Red;
        ...
        private Mq4OutputDataSeries HLNUp_sl;
        private Mq4OutputDataSeries HLNDn_sl;
        private Mq4OutputDataSeries HLNUp;
        private Mq4OutputDataSeries HLNDn;
        private Mq4OutputDataSeries BLLev;
        private Mq4OutputDataSeries BLStep;
        private Mq4OutputDataSeries ExtMapBuffer7;
        private Mq4OutputDataSeries ExtMapBuffer8;
        ...
        {
            if (HLNUp_sl_AlgoOutputDataSeries == null)
                HLNUp_sl_AlgoOutputDataSeries = CreateDataSeries();
            HLNUp_sl = new Mq4OutputDataSeries(this, HLNUp_sl_AlgoOutputDataSeries, ChartObjects, 0, 0, () => CreateDataSeries(), 1, Colors.DeepSkyBlue);
            AllBuffers.Add(HLNUp_sl);
            if (HLNDn_sl_AlgoOutputDataSeries == null)
                HLNDn_sl_AlgoOutputDataSeries = CreateDataSeries();
            HLNDn_sl = new Mq4OutputDataSeries(this, HLNDn_sl_AlgoOutputDataSeries, ChartObjects, 0, 1, () => CreateDataSeries(), 1, Colors.Black);
            AllBuffers.Add(HLNDn_sl);
            if (HLNUp_AlgoOutputDataSeries == null)
                HLNUp_AlgoOutputDataSeries = CreateDataSeries();
            HLNUp = new Mq4OutputDataSeries(this, HLNUp_AlgoOutputDataSeries, ChartObjects, 0, 2, () => CreateDataSeries(), 1, Colors.DeepSkyBlue);
            AllBuffers.Add(HLNUp);
            if (HLNDn_AlgoOutputDataSeries == null)
                HLNDn_AlgoOutputDataSeries = CreateDataSeries();
            HLNDn = new Mq4OutputDataSeries(this, HLNDn_AlgoOutputDataSeries, ChartObjects, 0, 3, () => CreateDataSeries(), 1, Colors.Black);
            AllBuffers.Add(HLNDn);
            if (BLLev_AlgoOutputDataSeries == null)
                BLLev_AlgoOutputDataSeries = CreateDataSeries();
            BLLev = new Mq4OutputDataSeries(this, BLLev_AlgoOutputDataSeries, ChartObjects, 0, 4, () => CreateDataSeries(), 1, Colors.Yellow);
            AllBuffers.Add(BLLev);
            if (BLStep_AlgoOutputDataSeries == null)
                BLStep_AlgoOutputDataSeries = CreateDataSeries();
            BLStep = new Mq4OutputDataSeries(this, BLStep_AlgoOutputDataSeries, ChartObjects, 0, 5, () => CreateDataSeries(), 1, Colors.Green);
            AllBuffers.Add(BLStep);
            if (ExtMapBuffer7_AlgoOutputDataSeries == null)
                ExtMapBuffer7_AlgoOutputDataSeries = CreateDataSeries();
            ExtMapBuffer7 = new Mq4OutputDataSeries(this, ExtMapBuffer7_AlgoOutputDataSeries, ChartObjects, 0, 6, () => CreateDataSeries(), 1, Colors.Red);
            AllBuffers.Add(ExtMapBuffer7);
            if (ExtMapBuffer8_AlgoOutputDataSeries == null)
                ExtMapBuffer8_AlgoOutputDataSeries = CreateDataSeries();
            ExtMapBuffer8 = new Mq4OutputDataSeries(this, ExtMapBuffer8_AlgoOutputDataSeries, ChartObjects, 0, 7, () => CreateDataSeries(), 1, Colors.Red);
            AllBuffers.Add(ExtMapBuffer8);

            AllOutputDataSeries.Add(HLNUp_sl_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(HLNDn_sl_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(HLNUp_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(HLNDn_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(BLLev_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(BLStep_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(ExtMapBuffer7_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(ExtMapBuffer8_AlgoOutputDataSeries);
        ...
        public override void Calculate(int index)
        {
            ...
            {
                _currentIndex = index;
                HLNUp_sl.SetCurrentIndex(index);
                HLNDn_sl.SetCurrentIndex(index);
                HLNUp.SetCurrentIndex(index);
                HLNDn.SetCurrentIndex(index);
                BLLev.SetCurrentIndex(index);
                BLStep.SetCurrentIndex(index);
                ExtMapBuffer7.SetCurrentIndex(index);
                ExtMapBuffer8.SetCurrentIndex(index);
...
//{
        ...
        class Mq4OutputDataSeries : IMq4DoubleArray
        {
            ...
            private readonly GANN_rvm_v4_Indicator _indicator;

            public Mq4OutputDataSeries(GANN_rvm_v4_Indicator indicator, IndicatorDataSeries outputDataSeries, ChartObjects chartObjects, int style, int bufferIndex, Func<IndicatorDataSeries> dataSeriesFactory, int lineWidth, Colors? color = null)
            {
            ...
            public override void Draw()
            {
                ...
                switch (ArrowCode)
                {
                    ...
                    case SYMBOL_LEFTPRICE:
                        ...
                        break;
                    default:
                        arrowString = GANN_rvm_v4_Indicator.GetArrowByCode(ArrowCode);
