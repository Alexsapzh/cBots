...
namespace cAlgo.Indicators
{
    ...
    [Levels()]
    public class SimpleBars_Indicator : Indicator
    {
        Mq4Double Mq4Init()
        {
            IndicatorBuffers(5);
        ...
        Mq4Double Mq4Start()
        {
            ...
            for (i = limit - 1; i >= 0; i--)
            {
                ...
                if (trand[i + 1] == 0 || trand[i + 1] == EMPTY_VALUE)
                {
                    if (Close[i] > Open[i])
                    {
                        trand[i] = 1;
        ...
        [Parameter("period", DefaultValue = 6)]
        ...
        Mq4Double period
        {
            ...
            {
                if (!_periodGot)
                    period_backfield = period_parameter;
                return period_backfield;
            }
            set { period_backfield = value; }
        }

        [Parameter("useClose", DefaultValue = true)]
        public bool useClose_parameter { get; set; }
        bool _useCloseGot;
        Mq4Double useClose_backfield;
        Mq4Double useClose
        {
            get
            {
                if (!_useCloseGot)
                    useClose_backfield = useClose_parameter;
                return useClose_backfield;
            }
            set { useClose_backfield = value; }
        }

        [Parameter("width", DefaultValue = 1)]
        public int width_parameter { get; set; }
        bool _widthGot;
        Mq4Double width_backfield;
        Mq4Double width
        {
            get
            {
                if (!_widthGot)
                    width_backfield = width_parameter;
                return width_backfield;
            }
            set { width_backfield = value; }
        }



        public IndicatorDataSeries bufferRed1_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries bufferGreen1_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries bufferRed2_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries bufferGreen2_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries trand_AlgoOutputDataSeries { get; set; }
        ...
        private Mq4OutputDataSeries bufferRed1;
        private Mq4OutputDataSeries bufferGreen1;
        private Mq4OutputDataSeries bufferRed2;
        private Mq4OutputDataSeries bufferGreen2;
        private Mq4OutputDataSeries trand;
        ...
        {
            if (bufferRed1_AlgoOutputDataSeries == null)
                bufferRed1_AlgoOutputDataSeries = CreateDataSeries();
            bufferRed1 = new Mq4OutputDataSeries(this, bufferRed1_AlgoOutputDataSeries, ChartObjects, 2, 0, () => CreateDataSeries(), 1, Colors.Red);
            AllBuffers.Add(bufferRed1);
            if (bufferGreen1_AlgoOutputDataSeries == null)
                bufferGreen1_AlgoOutputDataSeries = CreateDataSeries();
            bufferGreen1 = new Mq4OutputDataSeries(this, bufferGreen1_AlgoOutputDataSeries, ChartObjects, 2, 1, () => CreateDataSeries(), 1, Colors.Green);
            AllBuffers.Add(bufferGreen1);
            if (bufferRed2_AlgoOutputDataSeries == null)
                bufferRed2_AlgoOutputDataSeries = CreateDataSeries();
            bufferRed2 = new Mq4OutputDataSeries(this, bufferRed2_AlgoOutputDataSeries, ChartObjects, 2, 2, () => CreateDataSeries(), 1, Colors.Red);
            AllBuffers.Add(bufferRed2);
            if (bufferGreen2_AlgoOutputDataSeries == null)
                bufferGreen2_AlgoOutputDataSeries = CreateDataSeries();
            bufferGreen2 = new Mq4OutputDataSeries(this, bufferGreen2_AlgoOutputDataSeries, ChartObjects, 2, 3, () => CreateDataSeries(), 1, Colors.Green);
            AllBuffers.Add(bufferGreen2);
            if (trand_AlgoOutputDataSeries == null)
                trand_AlgoOutputDataSeries = CreateDataSeries();
            trand = new Mq4OutputDataSeries(this, trand_AlgoOutputDataSeries, ChartObjects, 12, 4, () => CreateDataSeries(), 1, null);
            AllBuffers.Add(trand);

            AllOutputDataSeries.Add(bufferRed1_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(bufferGreen1_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(bufferRed2_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(bufferGreen2_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(trand_AlgoOutputDataSeries);
        ...
        public override void Calculate(int index)
        {
            ...
            {
                _currentIndex = index;
                bufferRed1.SetCurrentIndex(index);
                bufferGreen1.SetCurrentIndex(index);
                bufferRed2.SetCurrentIndex(index);
                bufferGreen2.SetCurrentIndex(index);
                trand.SetCurrentIndex(index);
        ...
        class Mq4OutputDataSeries : IMq4DoubleArray
        {
            ...
            private readonly SimpleBars_Indicator _indicator;

            public Mq4OutputDataSeries(SimpleBars_Indicator indicator, IndicatorDataSeries outputDataSeries, ChartObjects chartObjects, int style, int bufferIndex, Func<IndicatorDataSeries> dataSeriesFactory, int lineWidth, Colors? color = null)
            {
            ...
            public override void Draw()
            {
                ...
                switch (ArrowCode)
                {
                    ...
                    case SYMBOL_LEFTPRICE:
                        ...
                        break;
                    default:
                        arrowString = SimpleBars_Indicator.GetArrowByCode(ArrowCode);
