...
namespace cAlgo.Indicators
{
    ...
    [Levels()]
    public class Supertrend_Indicator : Indicator
    {
        Mq4Double Mq4Init()
        {
        ...
        Mq4Double Mq4Start()
        {
            ...
            Mq4Double var = 0;
            Mq4Double cciTrendPrevious = 0;
            Mq4Double cciTrendNow = 0;
            Mq4Double AvgRange = 0;
            Mq4Double Range = 0;
            Mq4Double counter = 0;
            Mq4Double i = 0;
            Mq4Double limit = 0;
        ...
        [Output("TrendUp", Color = Colors.Lime, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries TrendUp_AlgoOutputDataSeries { get; set; }
        [Output("TrendDown", Color = Colors.Red, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries TrendDown_AlgoOutputDataSeries { get; set; }
        ...
        private Mq4OutputDataSeries TrendUp;
        private Mq4OutputDataSeries TrendDown;
        ...
        {
            if (TrendUp_AlgoOutputDataSeries == null)
                TrendUp_AlgoOutputDataSeries = CreateDataSeries();
            TrendUp = new Mq4OutputDataSeries(this, TrendUp_AlgoOutputDataSeries, ChartObjects, 0, 0, () => CreateDataSeries(), 2, Colors.Lime);
            AllBuffers.Add(TrendUp);
            if (TrendDown_AlgoOutputDataSeries == null)
                TrendDown_AlgoOutputDataSeries = CreateDataSeries();
            TrendDown = new Mq4OutputDataSeries(this, TrendDown_AlgoOutputDataSeries, ChartObjects, 0, 1, () => CreateDataSeries(), 2, Colors.Red);
            AllBuffers.Add(TrendDown);

            AllOutputDataSeries.Add(TrendUp_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(TrendDown_AlgoOutputDataSeries);
        ...
        public override void Calculate(int index)
        {
            ...
            {
                _currentIndex = index;
                TrendUp.SetCurrentIndex(index);
                TrendDown.SetCurrentIndex(index);
        ...
        class Mq4OutputDataSeries : IMq4DoubleArray
        {
            ...
            private readonly Supertrend_Indicator _indicator;

            public Mq4OutputDataSeries(Supertrend_Indicator indicator, IndicatorDataSeries outputDataSeries, ChartObjects chartObjects, int style, int bufferIndex, Func<IndicatorDataSeries> dataSeriesFactory, int lineWidth, Colors? color = null)
            {
            ...
            public override void Draw()
            {
                ...
                switch (ArrowCode)
                {
                    ...
                    case SYMBOL_LEFTPRICE:
                        ...
                        break;
                    default:
                        arrowString = Supertrend_Indicator.GetArrowByCode(ArrowCode);
