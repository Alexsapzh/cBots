...
namespace cAlgo.Indicators
{
    ...
    public class ConvertedIndicator : Indicator
    {
        ...
        Mq4Double Mq4Init()
        {
            ...
            SetIndexLabel(1, "Red");
            SetIndexLabel(2, "ForestGreen");
            SetIndexLabel(3, "HotPink");
        ...
        Mq4Double Mq4Start()
        {
            ...
            for (i = limit; i >= 0; i--)
            {
                ...
                if (TimeDay(Time[i]) != TimeDay(Time[i + 1]))
                {
                    ...
                    if (ObjectFind("PrevDayHi") != 0)
                    {
                        ...
                        ObjectSetText("PrevDayHi", "           Day High", fontsize, "Arial");
                        ObjectSet("PrevDayHi", OBJPROP_COLOR, Yellow);
                        ObjectSet("PrevDayHi", OBJPROP_WIDTH, 5);
                    }
                    else
                    {
                    ...
                    if (ObjectFind("PrevDayLo") != 0)
                    {
                        ...
                        ObjectSetText("PrevDayLo", "           Day Low", fontsize, "Arial");
                        ObjectSet("PrevDayLo", OBJPROP_COLOR, Yellow);
                        ObjectSet("PrevDayLo", OBJPROP_WIDTH, 5);
            ...
            if (Ask > LastClose)
            {
                ...
                if ((ra1 > 2) && (ra2 > 2) && (ra3 > 2))
                    Comment("Owner : ", AccountName(), " AccountMq4 number : ", AccountNumber(), "\n\nPrevDayHi ", PrevDayHi, "\nPrevDayLo ", PrevDayLo, "\nTrend was UP ", "\nBUY @ ",
                    fb, "\nStopLoss ", fe, "\nTakeProit 1 ", tp1, " Risk/Reward Ratio : ", ra1, " OK TradeMq4 ", "\nTakeProit 2 ", tp2,
                    " Risk/Reward Ratio : ", ra2, " OK TradeMq4 ", "\nTakeProit 3 ", tp3, " Risk/Reward Ratio : ", ra3, " OK TradeMq4 ");
                else
                    Comment("Owner : ", AccountName(), " AccountMq4 number : ", AccountNumber(), "\n\nPrevDayHi ", PrevDayHi, "\nPrevDayLo ", PrevDayLo, "\nTrend was UP ", "\nBUY @ ",
        ...
        [Output("PrevDayHiBuffer", Color = Colors.Blue, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries PrevDayHiBuffer_AlgoOutputDataSeries { get; set; }
        [Output("PrevDayLoBuffer", Color = Colors.Red, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries PrevDayLoBuffer_AlgoOutputDataSeries { get; set; }
        [Output("PrevDayOpenBuffer", Color = Colors.ForestGreen, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries PrevDayOpenBuffer_AlgoOutputDataSeries { get; set; }
        [Output("PrevDayCloseBuffer", Color = Colors.HotPink, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries PrevDayCloseBuffer_AlgoOutputDataSeries { get; set; }
        ...
        Mq4Double fs;
        Mq4Double fb;
        Mq4Double PrevDayClose;
        Mq4Double PrevDayOpen;
        Mq4Double PrevDayLo;
        Mq4Double PrevDayHi;
        Mq4Double fontsize = 8;

        int indicator_buffers = 4;
        int indicator_color1 = Blue;
        int indicator_color2 = Red;
        int indicator_color3 = ForestGreen;
        int indicator_color4 = HotPink;
        ...
        private Mq4OutputDataSeries PrevDayHiBuffer;
        private Mq4OutputDataSeries PrevDayLoBuffer;
        private Mq4OutputDataSeries PrevDayOpenBuffer;
        private Mq4OutputDataSeries PrevDayCloseBuffer;
        ...
        {
            if (PrevDayHiBuffer_AlgoOutputDataSeries == null)
                PrevDayHiBuffer_AlgoOutputDataSeries = CreateDataSeries();
            PrevDayHiBuffer = new Mq4OutputDataSeries(this, PrevDayHiBuffer_AlgoOutputDataSeries, ChartObjects, 0, 0, () => CreateDataSeries(), 1, Colors.Blue);
            AllBuffers.Add(PrevDayHiBuffer);
            if (PrevDayLoBuffer_AlgoOutputDataSeries == null)
                PrevDayLoBuffer_AlgoOutputDataSeries = CreateDataSeries();
            PrevDayLoBuffer = new Mq4OutputDataSeries(this, PrevDayLoBuffer_AlgoOutputDataSeries, ChartObjects, 0, 1, () => CreateDataSeries(), 1, Colors.Red);
            AllBuffers.Add(PrevDayLoBuffer);
            if (PrevDayOpenBuffer_AlgoOutputDataSeries == null)
                PrevDayOpenBuffer_AlgoOutputDataSeries = CreateDataSeries();
            PrevDayOpenBuffer = new Mq4OutputDataSeries(this, PrevDayOpenBuffer_AlgoOutputDataSeries, ChartObjects, 0, 2, () => CreateDataSeries(), 1, Colors.ForestGreen);
            AllBuffers.Add(PrevDayOpenBuffer);
            if (PrevDayCloseBuffer_AlgoOutputDataSeries == null)
                PrevDayCloseBuffer_AlgoOutputDataSeries = CreateDataSeries();
            PrevDayCloseBuffer = new Mq4OutputDataSeries(this, PrevDayCloseBuffer_AlgoOutputDataSeries, ChartObjects, 0, 3, () => CreateDataSeries(), 1, Colors.HotPink);
            AllBuffers.Add(PrevDayCloseBuffer);

            AllOutputDataSeries.Add(PrevDayHiBuffer_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(PrevDayLoBuffer_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(PrevDayOpenBuffer_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(PrevDayCloseBuffer_AlgoOutputDataSeries);
        ...
        public override void Calculate(int index)
        {
            ...
            {
                _currentIndex = index;
                PrevDayHiBuffer.SetCurrentIndex(index);
                PrevDayLoBuffer.SetCurrentIndex(index);
                PrevDayOpenBuffer.SetCurrentIndex(index);
                PrevDayCloseBuffer.SetCurrentIndex(index);
