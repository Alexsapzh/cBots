...
namespace cAlgo.Indicators
{
    ...
    [Levels()]
    public class SSL_Indicator : Indicator
    {
        Mq4Double Mq4Init()
        {
        ...
        Mq4Double Mq4Start()
        {
            ...
            for (i = Bars - Lb; i >= 0; i--)
            {
                ...
                if (Hld != 0)
                    Hlv = Hld;
                if (Hlv == -1)
                    ssl[i] = iMA(Symbol.Code, 0, Lb, 0, MODE_SMA, PRICE_HIGH, i + 1);
                else
                    ssl[i] = iMA(Symbol.Code, 0, Lb, 0, MODE_SMA, PRICE_LOW, i + 1);
            }
            return 0;
            return 0;
        }
        ...
        [Output("ssl", Color = Colors.Blue, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries ssl_AlgoOutputDataSeries { get; set; }
        ...
        private Mq4OutputDataSeries ssl;
        ...
        {
            if (ssl_AlgoOutputDataSeries == null)
                ssl_AlgoOutputDataSeries = CreateDataSeries();
            ssl = new Mq4OutputDataSeries(this, ssl_AlgoOutputDataSeries, ChartObjects, 0, 0, () => CreateDataSeries(), 2, Colors.Blue);
            AllBuffers.Add(ssl);

            AllOutputDataSeries.Add(ssl_AlgoOutputDataSeries);
        ...
        class Mq4OutputDataSeries : IMq4DoubleArray
        {
            ...
            private readonly SSL_Indicator _indicator;

            public Mq4OutputDataSeries(SSL_Indicator indicator, IndicatorDataSeries outputDataSeries, ChartObjects chartObjects, int style, int bufferIndex, Func<IndicatorDataSeries> dataSeriesFactory, int lineWidth, Colors? color = null)
            {
            ...
            public override void Draw()
            {
                ...
                switch (ArrowCode)
                {
                    ...
                    case SYMBOL_LEFTPRICE:
                        ...
                        break;
                    default:
                        arrowString = SSL_Indicator.GetArrowByCode(ArrowCode);
