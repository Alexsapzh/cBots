...
namespace cAlgo
{
    ...
    public class FibonacciGrid1m5m : Indicator
    {
        ...
        [Output("5m Upper Band 1", PlotType = PlotType.Line, Color = Colors.Lime)]
        public IndicatorDataSeries UpperBand5 { get; set; }

        [Output("5m Upper Band 2", PlotType = PlotType.Line, Color = Colors.Lime)]
        public IndicatorDataSeries UpperBand6 { get; set; }

        [Output("5m Upper Band 3", PlotType = PlotType.Line, Color = Colors.Lime)]
        public IndicatorDataSeries UpperBand7 { get; set; }

        [Output("5m Upper Band 4", PlotType = PlotType.Line, Color = Colors.Lime)]
