...
namespace cAlgo.Indicators
{
    ...
    [Levels()]
    public class TrendBands_Indicator : Indicator
    {
        Mq4Double Mq4Init()
        {
        ...
        Mq4Double Mq4Start()
        {
            ...
            for (x = 0; x < limit; x++)
            {
                middle1[x] = iMA(NULL, 0, period, 0, MODE_EMA, PRICE_TYPICAL, x);
                middle2 = iMA(NULL, 0, period, 0, MODE_SMA, PRICE_TYPICAL, x);

                avg = findAvgFunc(period, x);
        ...
        Mq4Double findAvgFunc(Mq4Double period, Mq4Double shift)
        {
            Mq4Double x = 0;
            Mq4Double sum = 0;
            sum = 0;
        ...
        [Parameter("period", DefaultValue = 34)]
        ...
        [Output("upper", Color = Colors.Yellow, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries upper_AlgoOutputDataSeries { get; set; }
        [Output("middle1", Color = Colors.Magenta, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries middle1_AlgoOutputDataSeries { get; set; }
        [Output("lower", Color = Colors.Yellow, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries lower_AlgoOutputDataSeries { get; set; }
        ...
        int indicator_color3 = Yellow;


        Mq4Double indicator_width1 = 2;
        Mq4Double indicator_width2 = 3;
        ...
        private Mq4OutputDataSeries upper;
        private Mq4OutputDataSeries middle1;
        private Mq4OutputDataSeries lower;
        ...
        {
            if (upper_AlgoOutputDataSeries == null)
                upper_AlgoOutputDataSeries = CreateDataSeries();
            upper = new Mq4OutputDataSeries(this, upper_AlgoOutputDataSeries, ChartObjects, 0, 0, () => CreateDataSeries(), 2, Colors.Yellow);
            AllBuffers.Add(upper);
            if (middle1_AlgoOutputDataSeries == null)
                middle1_AlgoOutputDataSeries = CreateDataSeries();
            middle1 = new Mq4OutputDataSeries(this, middle1_AlgoOutputDataSeries, ChartObjects, 0, 1, () => CreateDataSeries(), 3, Colors.Magenta);
            AllBuffers.Add(middle1);
            if (lower_AlgoOutputDataSeries == null)
                lower_AlgoOutputDataSeries = CreateDataSeries();
            lower = new Mq4OutputDataSeries(this, lower_AlgoOutputDataSeries, ChartObjects, 0, 2, () => CreateDataSeries(), 2, Colors.Yellow);
            AllBuffers.Add(lower);

            AllOutputDataSeries.Add(upper_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(middle1_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(lower_AlgoOutputDataSeries);
        ...
        public override void Calculate(int index)
        {
            ...
            {
                _currentIndex = index;
                upper.SetCurrentIndex(index);
                middle1.SetCurrentIndex(index);
                lower.SetCurrentIndex(index);
        ...
        class Mq4OutputDataSeries : IMq4DoubleArray
        {
            ...
            private readonly TrendBands_Indicator _indicator;

            public Mq4OutputDataSeries(TrendBands_Indicator indicator, IndicatorDataSeries outputDataSeries, ChartObjects chartObjects, int style, int bufferIndex, Func<IndicatorDataSeries> dataSeriesFactory, int lineWidth, Colors? color = null)
            {
            ...
            public override void Draw()
            {
                ...
                switch (ArrowCode)
                {
                    ...
                    case SYMBOL_LEFTPRICE:
                        ...
                        break;
                    default:
                        arrowString = TrendBands_Indicator.GetArrowByCode(ArrowCode);
